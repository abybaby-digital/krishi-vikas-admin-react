...
export default function GoodsVehiclePostList() {
                    ...
                    <ToolTipGlobal toolText="Edit Post">
                        <button
                            ...
                            onClick={() => {
                                setModal(true);
                                setSinglePost(row);
                                navigate(`/pesticides/edit-post/${row.id}`);
    ...
    return (
        <SidebarProvider>
            <AppSidebar />
            <SidebarInset>
                <AdminHeader head_text="Pesticides Posts" />
                <div className="form-wrapper bg-white p-5">
                    <div className="flex justify-between form-heading bg-whitesmoke rounded-2xl mb-5 p-5">
                        <h2 className="text-2xl font-bold text-center font-dmsans">Pesticides Post List</h2>
                        <input
                            type="text"
                            placeholder="Search ..."
