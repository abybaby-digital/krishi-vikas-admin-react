    ...
    return (
        <Dialog open={modal}>
            ...
            <DialogContent className="p-8">
                <DialogHeader>
                    <DialogTitle className="bg-whitesmoke text-center p-3 font-dmsans rounded-xl">{seoModal ? "Update Meta Title & Description" : "View Tractor Post Details"}</DialogTitle>
                    <hr />
                    ...
                    postByIdLoading ?
                        ...
                        seoModal ?
                            ...
                            <div className="max-h-[80vh] overflow-y-auto py-4">
                                <div className="content-dialog grid md:grid-cols-[400px,1fr] grid-cols-1 gap-5">
                                    ...
                                    <div className="right-post-data rounded-2xl overflow-hidden shadow">
                                        ...
                                        <div className="import-offline-lead rounded-2xl overflow-hidden shadow m-2">
                                            <div className="flex flex-col space-y-2">
                                                ...
                                                >
                                                    <label className="font-medium block mb-2">Upload Offline Lead</label>
