    ...
    return (
        <Dialog open={modal}>
            ...
            <DialogContent className="p-8">
                    ...
                    <div className="left-post-data rounded-2xl overflow-hidden shadow">
                        <table className='w-full border border-collapse text-center'>
                            ...
                            {postViewById?.response.price && <tr className='border'>
                                ...
                                <td className='border p-2 font-bold'><LuIndianRupee className='inline' /> {`${postViewById?.response.price} ${postViewById?.response.set_sell_or_rent === "rent" ? postViewById.response.rent_type : null}`}</td>
                            </tr>}
                ...
                {
                    changeApprovalPostMutation.isPending ? <Loader /> : null
                }
            </DialogContent>
        </Dialog>
    );
