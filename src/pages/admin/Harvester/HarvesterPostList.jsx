...
export default function HarvesterPostList() {
                    ...
                    <ToolTipGlobal toolText="Edit Post">
                        <button
                            ...
                            onClick={() => {
                                setModal(true);
                                setSinglePost(row);
                                navigate(`/harvester/edit-post/${row.id}`);
    ...
    return (
        <SidebarProvider>
            <AppSidebar />
            <SidebarInset>
                <AdminHeader head_text="Harvester Posts" />
                <div className="form-wrapper bg-white p-5">
                    <div className="flex justify-between form-heading bg-whitesmoke rounded-2xl mb-5 p-5">
                        <h2 className="text-2xl font-bold text-center font-dmsans">Harvester Post List</h2>
                        <input
                            type="text"
                            placeholder="Search ..."
