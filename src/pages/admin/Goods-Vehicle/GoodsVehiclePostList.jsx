...
import ViewGoodsVehiclePost from "./ViewGoodsVehiclePost";
...
export default function GoodsVehiclePostList() {
    ...
    const {
        ...
        queryKey: ["goods-vehicle-posts"],
        queryFn: () => categoryWiseProductList(token, 3, skip, take),
    });
    ...
    return (
        <SidebarProvider>
            <AppSidebar />
            <SidebarInset>
                <AdminHeader head_text="Goods Vehicle Posts" />
                <div className="form-wrapper bg-white p-5">
                    <div className="flex justify-between form-heading bg-whitesmoke rounded-2xl mb-5 p-5">
                        <h2 className="text-2xl font-bold text-center font-dmsans">Goods Vehicle Post List</h2>
                        <input
                            type="text"
                            placeholder="Search ..."
                ...
                <ViewGoodsVehiclePost modal={modal} setModal={setModal} singlePostData={singlePostData} seoModal={seoModal} setSeoModal={setSeoModal} />
            </SidebarInset>
        </SidebarProvider>
    );
}
